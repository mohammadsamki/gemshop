...
// //  home screen that contain a list of videos
// //  1- if we press the play button, the video will start playing
// //  2- if we press the pause button, the video will stop playing
// //  3- if we press the next button, the video will play the next video in the list
...
class _ButterFlyAssetVideoState extends State<_ButterFlyAssetVideo> {
  ...
  String videoTitile = 'with assets mp5';
